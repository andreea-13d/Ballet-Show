...
try {if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result){
        ...
        $query = "UPDATE recenzii SET text_recenzie = :text_recenzie where id_spectator = :id_spectator and id_program=:id_program ";
        ...
        //echo "update reusit!";
        echo '<div style="color: green; text-align: center; font-size: 100px;">Recenzie modificata cu succes!</div>';
        echo '<script>
                setTimeout(function() {
...
<html>
<head>
    <title>Modifica o recenzie</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
    
    <div class="login">
	<h2>Modifica o recenzie</h2><br>
    <form id="register" method="post" action="update_review.php">
        <label><b>Username
        </b>
        </label>
